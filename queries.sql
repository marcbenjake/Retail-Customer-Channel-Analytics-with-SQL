...
-- ============================================================
-- BEGINNER: Q1 - Q5
-- Core SQL fluency - aggregations, grouping, filtering, and CASE WHEN logic
-- ============================================================
...
-- The high mobile order volume and AOV suggest the storefront is well optimized for mobile commerce.


-- ============================================================
-- INTERMEDIATE: Q6 - Q10
-- Working across tables analytically - JOINs, subqueries, and segmentation
-- ============================================================
...
-- ============================================================
-- ADVANCED: Q11 - Q16
-- Analytical thinking beyond querying - window functions, CTEs, and business metric calculations
-- ============================================================
